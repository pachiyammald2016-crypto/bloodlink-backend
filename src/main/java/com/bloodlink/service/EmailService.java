...
public class EmailService {
    ...
    public void sendWelcomeEmail(Donor donor) {
        ...
        String htmlContent = "<!DOCTYPE html>"
                ...
                + "<table width='240' cellpadding='0' cellspacing='0' border='0' align='right' style='margin-right: 15px; text-align: left;'>"
                + "<tr><td>"
                ...
                + "<table width='40%' height='100%' cellpadding='0' cellspacing='0' border='0' align='right' style='padding-right: 10px;'>"
                + "<tr><td valign='middle'>"
