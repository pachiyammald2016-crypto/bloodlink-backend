...
public class EmailService {
    ...
    public void sendWelcomeEmail(Donor donor) {
        ...
        String htmlContent = "<div style='font-family: \"Helvetica Neue\", Arial, sans-serif; max-width: 550px; margin: auto; background-color: #f9f9f9; padding: 30px; border-radius: 12px;'>"
                ...
                + "<table width='260' cellpadding='0' cellspacing='0' border='0' align='right' style='margin-right: 25px; text-align: left;'>"
                + "<tr>"
                + "<td>"
                ...
                + "<p style='margin: 0; font-size: 15px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase; color: #ffffff;'>DONOR ID</p>"
                + "</td>"
                + "<td align='right' valign='middle'>"
                + "<div style='background-color: #ffffff; color: #cc0000; padding: 3px 8px; border-radius: 4px; font-size: 15px; font-weight: 900; box-shadow: 0 2px 5px rgba(0,0,0,0.3); display: inline-block;'>"
                + donor.getBloodGroup()
                + "</div>"
                + "</td>"
                + "</tr>"
