...
public class EmailService {
    ...
    public void sendWelcomeEmail(Donor donor) {
        ...
        String htmlContent = "<div style='font-family: \"Helvetica Neue\", Arial, sans-serif; max-width: 550px; margin: auto; background-color: #f9f9f9; padding: 30px; border-radius: 12px;'>"
                ...
                + "<tr>"
                + "<!-- Spacer for the globe on the left -->"
                + "<td width='45%'>&nbsp;</td>"
                + "<!-- Details on the right -->"
                + "<td width='55%' valign='middle' style='padding: 20px 25px 20px 10px;'>"
                
                + "<!-- Header -->"
                + "<table width='100%' cellpadding='0' cellspacing='0' border='0' style='border-bottom: 1px solid rgba(255,255,255,0.3); padding-bottom: 8px; margin-bottom: 10px;'>"
                + "<tr>"
                + "<td align='left' valign='middle'>"
                + "<p style='margin: 0; font-size: 14px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase; color: #ffffff;'>DONOR ID</p>"
                + "</td>"
                + "<td align='right' valign='middle'>"
                + "<div style='background-color: #ffffff; color: #cc0000; padding: 3px 8px; border-radius: 4px; font-size: 14px; font-weight: 900; box-shadow: 0 2px 5px rgba(0,0,0,0.3); display: inline-block;'>"
                + donor.getBloodGroup()
                + "</div>"
                + "</td>"
                + "</tr>"
                ...
                + "<!-- Details -->"
                + "<table width='100%' cellpadding='0' cellspacing='0' border='0' style='font-size: 12px; line-height: 1.4; color: #ffffff;'>"
                + "<tr>"
                ...
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 15px; font-weight: 900; text-transform: uppercase; padding-bottom: 6px;'>" + donor.getName() + "</td>"
                + "</tr>"
                + "<tr>"
                ...
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 13px; font-weight: 600; padding-bottom: 6px;'>" + donor.getArea() + ", " + donor.getCity() + "</td>"
                + "</tr>"
                + "<tr>"
                ...
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 13px; font-weight: 600; padding-bottom: 6px;'>+91 " + donor.getPhone() + "</td>"
                + "</tr>"
                + "<tr>"
