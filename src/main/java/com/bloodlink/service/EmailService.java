...
public class EmailService {
    ...
    public void sendWelcomeEmail(Donor donor) {
        ...
        String htmlContent = "<div style='font-family: \"Helvetica Neue\", Arial, sans-serif; max-width: 550px; margin: auto; background-color: #f9f9f9; padding: 30px; border-radius: 12px;'>"
                ...
                + "<!-- ID Card Container (Bulletproof Table) -->"
                ...
                + "<!-- Details -->"
                + "<table width='100%' cellpadding='0' cellspacing='0' border='0' style='font-size: 11px; line-height: 1.3; color: #ffffff;'>"
                + "<tr>"
                + "<td style='color: #ffcccc; text-transform: uppercase; font-size: 8px; font-weight: bold; letter-spacing: 0.5px; padding-bottom: 2px;'>Name</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 14px; font-weight: 900; text-transform: uppercase; padding-bottom: 5px;'>" + donor.getName() + "</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='color: #ffcccc; text-transform: uppercase; font-size: 8px; font-weight: bold; letter-spacing: 0.5px; padding-bottom: 2px;'>Location</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 12px; font-weight: 600; padding-bottom: 5px;'>" + donor.getArea() + ", " + donor.getCity() + "</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='color: #ffcccc; text-transform: uppercase; font-size: 8px; font-weight: bold; letter-spacing: 0.5px; padding-bottom: 2px;'>Contact</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 12px; font-weight: 600; padding-bottom: 5px;'>+91 " + donor.getPhone() + "</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='color: #ffcccc; text-transform: uppercase; font-size: 8px; font-weight: bold; letter-spacing: 0.5px; padding-bottom: 2px;'>Card No.</td>"
                + "</tr>"
                + "<tr>"
                + "<td style='font-size: 12px; font-family: monospace; font-weight: 900; letter-spacing: 1px; color: #ffeb3b;'>BLD-" + donorId + "</td>"
                + "</tr>"
                + "</table>"
